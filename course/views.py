...
class CourseListView(View):
    def get(self, request):
        ctx = {
            'course': Course.objects.filter(is_active=True).order_by('title', 'id'),
            'title': 'Courses'
        }
        return render(request, 'course/course_list.html', ctx)
...
class CourseCreateView(LoginRequiredMixin, View):
    def get(self, request):
        ...
        return render(request, 'course/course_create.html', {'form': form, 'title': 'New Course'})
...
class CourseUpdateView(LoginRequiredMixin, View):
    def get(self, request, course_slug):
        ...
        return render(request, 'course/course_update.html', context=ctx)
...
class PracticeCategoryView(LoginRequiredMixin, View):
    def get(self, request, course_slug):
        ...
        return render(request, 'course/practice_category.html', ctx)
...
class TranslationPracticeListView(LoginRequiredMixin, View):
    def get(self, request, course_slug):
        ...
        return render(request, 'course/translation_practice_list.html', ctx)
...
class TranslationPracticeCreateView(LoginRequiredMixin, View):
    def get(self, request, course_slug):
        ...
        return render(request, 'course/translation_practice_create.html', ctx)
...
class TranslationPracticeUpdateView(LoginRequiredMixin, View):
    def get(self, request, course_slug, tp_slug):
        ...
        return render(request, 'course/translation_practice_update.html', ctx)
...
class TranslationPracticeView(LoginRequiredMixin, View):
    def get(self, request, course_slug, tp_slug):
        ...
        return render(request, 'course/translation_practice.html', ctx)
...
class SpeakingPracticeListView(LoginRequiredMixin, View):
    def get(self, request, course_slug):
        ...
        return render(request, 'course/speaking_practice_list.html', ctx)
...
class SpeakingPracticeCreateView(LoginRequiredMixin, View):
    def get(self, request, course_slug):
        ...
        return render(request, 'course/speaking_practice_create.html', ctx)
...
class SpeakingPracticeUpdateView(LoginRequiredMixin, View):
    def get(self, request, course_slug, sp_slug):
        ...
        return render(request, 'course/speaking_practice_update.html', ctx)
...
class SpeakingPracticeView(LoginRequiredMixin, View):
    def get(self, request, course_slug, sp_slug):
        ...
        return render(request, 'course/speaking_practice.html', ctx)
...
class TranslationPracticeQuestionView(LoginRequiredMixin, View):
    def get(self, request, course_slug, tp_slug):
        ...
        html_content = render(request, 'course/translation_practice_question.html', ctx)
...
class SpeakingPracticeQuestionView(LoginRequiredMixin, View):
    def get(self, request, course_slug, sp_slug):
        ...
        html_content = render(request, 'course/speaking_practice_question.html', ctx)
        return HttpResponse(html_content)
