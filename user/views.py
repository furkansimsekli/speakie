...
class RegisterView(View):
    def get(self, request):
        ...
        return render(request, 'user/register.html', {'form': form, 'title': 'Join!'})
...
class ProfileView(LoginRequiredMixin, View):
    def get(self, request):
        ...
        return render(request, 'user/profile.html', {'form': form, 'level': level, 'title': 'Profile'})
    ...
    def post(self, request):
        ...
        return render(request, 'user/profile.html', {'form': form, 'title': 'Profile'})


class PasswordRequestView(View):
    def get(self, request):
        form = forms.PasswordResetRequestForm()
        return render(request, 'user/password_reset_request.html', context={'form': form, 'title': 'Password Reset'})
...
class AppointModeratorView(LoginRequiredMixin, View):
    def get(self, request):
        ...
        return render(request, 'user/appoint_moderator.html', {'page_obj': page_object, 'title': 'Appoint Moderator'})
